...
class CreateAudienceMemberTest < ApplicationSystemTestCase
  context 'when user is authenticated' do
    should 'create with success when the data are valid' do
      ...
      visit admins_new_audience_member_path
      ...
      assert_selector('div.alert.alert-success', text: I18n.t('flash.actions.create.m', { resource_name: I18n.t('activerecord.models.audience_member.one') }))
    end
